...
int test1(){
    ...
    {
        #pragma acc wait(async_arg)
    }
    #pragma acc parallel async(async_arg)
    {
        #pragma acc wait(dev_num: dev_num)
    }
    #pragma acc parallel async(wait_arg)
    {
        #pragma acc wait(dev_num: dev_num)
    ...
    #pragma acc parallel async(async_arg)
    {
        #pragma acc wait(dev_num: dev_num, queues: wait_arg)
    }
    #pragma acc parallel async(wait_arg)
    {
        #pragma acc wait(dev_num: dev_num, queues: async_arg)
    }
    #pragma acc parallel async(async_arg)
    {
        #pragma acc wait(async_arg)
